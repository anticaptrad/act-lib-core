...
func DecodeAndValidate[T any](data []byte) (T, error) {
	...
	if err := decoder.Decode(&struct{}{}); err != io.EOF { if err == nil { return value, fmt.Errorf("decode public value: trailing JSON value") }; return value, fmt.Errorf("decode public value: %w", err) }
